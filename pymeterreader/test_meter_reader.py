...
from pymeterreader.device_lib.common import Sample, Channel
...
SAMPLE_BME.channels = [Channel('TEMPERATURE', 20.0, 'C'), Channel('HUMIDITY', 50.0, '%'),
                       Channel('PRESSURE', 1000.0, 'hPa')]

SAMPLE_SML = Sample()
SAMPLE_SML.meter_id = '1 EMH00 12345678'
SAMPLE_SML.channels = [Channel('1.8.0*255', 10000, 'kWh')]

SAMPLE_PLAIN = Sample()
SAMPLE_PLAIN.meter_id = 888777666
SAMPLE_PLAIN.channels = [Channel('6.8', 20000, 'kWh')]
