...
from pymeterreader.device_lib.common import Device, Channel
...
class TestSmlMeters(unittest.TestCase):
    ...
    def test_detect(self, mock_serial, mock_listdir):
        ...
        self.assertIn(Channel('6.8', '0006047', 'kWh'), devices[1].channels)
        self.assertIn(Channel('6.26', '00428.35', 'm3'), devices[1].channels)
